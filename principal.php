...
require_once "includes/modelos/modelo.asignatura.php";
require_once "includes/modelos/modelo.docente.php";
...
require_once "includes/controladores/controlador.asignatura.php";
require_once "includes/controladores/controlador.docente.php";
