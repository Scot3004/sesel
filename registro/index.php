<?php
	...
	render('_headerup',array('title'=>"Registro de usuario"))
?>
	...
	<script type='text/javascript'>//<![CDATA[ 
		$(window).load(function(){
			$('#linkmode').live('click', function() {
				$('#linkmode').datebox('open');
			});
		});//]]>  
	</script>
<form action="registro.php" data-ajax="false" method="post" >
	...
	<input name="fnacimiento" data-role="datebox" id="linkmode" data-options='{"noButton": true}' placeholder="" value="" type="date" data-mini="true" required/>
	<br/>
